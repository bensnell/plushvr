...
void MPUController::update() {
    ...
    ax = (float)xacc*aRes;  // get actual g value, this depends on scale being set
    ay = (float)yacc*aRes;
    az = (float)zacc*aRes;
    
    gx = (float)xgyr*gRes;  // get actual gyro value, this depends on scale being set
    gy = (float)ygyr*gRes;
    gz = (float)zgyr*gRes;
...
// Taken from Arduino MPU6050 Library:
...
void MPUController::MadgwickQuaternionUpdate(float ax, float ay, float az, float gx, float gy, float gz) {
