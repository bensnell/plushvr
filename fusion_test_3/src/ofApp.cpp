...
void ofApp::draw(){
    ...
    if (activity.bDraw) {
        ...
        activity.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
    ...
    if (linearity.bDraw) {
        ...
        linearity.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (reliability.bDraw) {
        if (py + ingrH > ofGetHeight()) {
            px = width;
            py = 0;
        }
        // draw the activity (average magnitude of flow)
        reliability.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (mixture1.bDraw) {
        ...
        // draw the mix
        mixture1.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (xComponent.bDraw) {
        ...
        xComponent.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (yComponent.bDraw) {
        ...
        yComponent.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (xStability.bDraw) {
        ...
        xStability.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (yStability.bDraw) {
        ...
        yStability.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (mixture2.bDraw) {
        ...
        mixture2.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (mixture3.bDraw) {
        ...
        mixture3.draw(px, py, ingrW, ingrH, {}, false);
        py += ingrH;
        width = max(width, (int)ingrW);
    }
    if (bDrawGui) {
...
void ofApp::updateDrawingSettings() {
    ...
    if (bDrawNone) {
        ...
        activity.bDraw = false;
        linearity.bDraw = false;
        reliability.bDraw = false;
        mixture1.bDraw = false;
        xComponent.bDraw = false;
        ...
        activity.bDraw = true;
        linearity.bDraw = true;
        reliability.bDraw = true;
        mixture1.bDraw = true;
        xComponent.bDraw = true;
